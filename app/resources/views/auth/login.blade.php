...
<div class="login-card">
    ...
    <div class="form-footer">
        <p class="footer-text">Don't have an account? <a href="/register" class="auth-link">Create one</a></p>
    </div>
</div>
...
<!-- Brand at top -->
<div class="login-brand" style="margin-bottom:2rem; text-align:center;">
    <div class="container">
